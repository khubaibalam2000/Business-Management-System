...
export default function Productions() {  
  ...
  useEffect(() => {
    axios.get('/we/ProdsView.php').then(response => {
  ...
  const onSubmit = (data) => {
    ...
    axios.post("/we/ProdsInsert.php", data).then(res => console.log(res.data));
    axios.get('/we/ProdsView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
  ...
  const onUpdate = () => {
    let item={name, bi, br, sales, rec_id};
    console.log("item", name, bi, br, sales, rec_id);
    axios.post('/we/ProdsUpdate.php', item).then(res => console.log(res.data));
    axios.get('/we/ProdsView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
  ...
  const onDelete = (data) => {
      console.log(data);
    axios.get("/we/ProdsDelete.php", { params: { id: data } }).then(console.log("data")).catch(err => console.log(err));
    axios.get('/we/ProdsView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.bi}</TableCell>
                      <TableCell align="center">{row.br}</TableCell>
          ...
          <Modal2 ref={modalRef2}>
            ...
            <FormControl variant="standard" >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{width: "60%"}}><TextField {...register("name", { required: true })} type="text" value={name} onChange={(e)=>{setName(e.target.value)}} id="standard-basic" label="Product Name" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("bi", { required: true })} value={bi} onChange={(e)=>{setBi(e.target.value)}} style={{width: "240%"}} id="standard-basic" label="Batches in Inventory" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("br", { required: true })} value={br} onChange={(e)=>{setBr(e.target.value)}} style={{ width: "240%"}} id="standard-basic" label="Batches Released" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{width: "60%"}}><TextField {...register("sales", { required: true })} type="text" value={sales} onChange={(e)=>{setSales(e.target.value)}} id="standard-basic" label="Total Sales (Monthly)" variant="standard" /></div>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
      ...
      <motion.button
        ...
        >
          ...
          <Modal2 ref={modalRef}>
            ...
            <FormControl variant="standard" >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{width: "60%"}}><TextField {...register("name", { required: true })} type="text"  id="standard-basic" label="Product Name" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("bi", { required: true })} style={{width: "240%"}} id="standard-basic" label="Batches in Inventory" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("br", { required: true })}   style={{ width: "240%"}} id="standard-basic" label="Batches Released" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{width: "60%"}}><TextField {...register("sales", { required: true })} type="text" id="standard-basic" label="Total Sales (Monthly)" variant="standard" /></div>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
