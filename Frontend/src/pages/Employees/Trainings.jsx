...
export default function Trainings() {  
  ...
  useEffect(() => {
    axios.get('/we/TrainView.php').then(response => {
  ...
  const onSubmit = (data) => {
    ...
    axios.post("/we/TrainInsert.php", data).then(res => console.log(res.data));
    axios.get('/we/TrainView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
  ...
  const onUpdate = () => {
    let item={topic, department, date, trainer, rec_id};
    console.log("item", item);
    axios.post('/we/TrainUpdate.php', item).then(res => console.log(res.data));
    axios.get('/we/TrainView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
  ...
  const onDelete = (data) => {
      console.log(data);
    axios.get("/we/TrainDelete.php", { params: { id: data } }).then(console.log("data")).catch(err => console.log(err));
    axios.get('/we/TrainView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
          ...
          <Modal2 ref={modalRef2}>
            ...
            <FormControl variant="standard" >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{width: "60%"}}><TextField {...register("topic", { required: true })} type="text" value={topic} onChange={(e)=>{setTopic(e.target.value)}} id="standard-basic" label="Topic" variant="standard" /></div>
                <div style={{width: "40%"}}>
              ...
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("date", { required: true })} value={date} onChange={(e)=>{setDate(e.target.value)}} style={{width: "240%"}} id="standard-basic" label="Date" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("trainer", { required: true })} value={trainer} onChange={(e)=>{setTrainer(e.target.value)}} style={{ width: "240%"}} id="standard-basic" label="Trainer" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
      ...
      <motion.button
        ...
        >
          ...
          <Modal2 ref={modalRef}>
            ...
            <FormControl variant="standard" >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{width: "60%"}}><TextField {...register("topic", { required: true })} type="text" id="standard-basic" label="Topic" variant="standard" /></div>
                <div style={{width: "40%"}}>
                  <InputLabel style={{marginLeft: "60%"}} variant="standard" htmlFor="uncontrolled-native">
                    Departments
                  </InputLabel>
              ...
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("date", { required: true })} style={{width: "240%"}} id="standard-basic" label="Date" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("trainer", { required: true })} style={{ width: "240%"}} id="standard-basic" label="Trainer" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
