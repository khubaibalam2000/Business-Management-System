...
export default function CRM() {  
  ...
  useEffect(() => {
    axios.get('/we/CRMView.php').then(response => {
  ...
  const onSubmit = (data) => {
    console.log(data);
    axios.post("/we/CRMInsert.php", data).then(res => console.log(res.data));
    axios.get('/we/CRMView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
  ...
  const onUpdate = () => {
    let item={name, review, rating, rec_id};
    console.log("item", item);
    axios.post('/we/CRMUpdate.php', item).then(res => console.log(res.data));
    axios.get('/we/CRMView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
  ...
  const onDelete = (data) => {
      console.log(data);
    axios.get("/we/CRMDelete.php", { params: { id: data } }).then(console.log("data")).catch(err => console.log(err));
    axios.get('/we/CRMView.php').then(response => {
      setRows({ rows2: response.data});
      setUser(rows2 ? Object.values(rows2)[0] : null);
      setRec_id();
        ...
        />
          ...
          <Modal2 ref={modalRef2}>
            ...
            <FormControl variant="standard" >
              ...
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("review", { required: true })} value={review} onChange={(e)=>{setReview(e.target.value)}} style={{width: "240%"}} id="standard-basic" label="Review" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("rating", { required: true })} value={rating} onChange={(e)=>{setRating(e.target.value)}} style={{ width: "240%"}} id="standard-basic" label="Rating" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
        ...
        >
          ...
          <Modal2 ref={modalRef}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("review", { required: true })}  style={{width: "240%"}} id="standard-basic" label="Review" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div><TextField {...register("rating", { required: true })}  style={{ width: "240%"}} id="standard-basic" label="Rating" variant="standard" /></div>
              </div>
              <br></br>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
